      ...
      {viewLiveFrame ? (
        <div className="icai-iframe-container">
          <div className="iframe-notice">
            <span>🌐 Live Connection to Official ICAI BOS Portal:</span>
            <a 
            ...
            >
              Open icaionlineregistration.org in new window ↗
            </a>
          </div>
          <iframe
            src="https://www.icaionlineregistration.org/launchbatchdetail.aspx"
            title="Official ICAI BOS Live Batch Portal"
